...
If you need more different props, you can open a [Pull Request](https://github.com/MatiPl01/react-native-sortable/) to add them or request them in the [GitHub Discussions](https://github.com/MatiPl01/react-native-sortable/discussions).
