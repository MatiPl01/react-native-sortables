...
Auto scroll settings control the **behavior of the grid** when the active item is dragged **close to the edges** of the grid. They are used to **automatically scroll** the grid when the active item is close to the edges.
...
You can provide a s**ingle number**, which will be used for both **top** and **bottom** edges or an array of **two numbers**, first for **top** edge and second for **bottom** edge.
