  ...
  return (
    <View style={styles.container}>
      <Sortable.Grid
        ...
        rowGap={10}
        showDropIndicator // enables drop indicator
      />
    </View>
  );
}
  ...
  return (
    <View style={styles.container}>
      <Sortable.Grid
        ...
        columns={3}
        data={DATA}
        dropIndicatorStyle={styles.dropIndicator} // custom drop indicator style
        renderItem={renderItem}
        rowGap={10}
        showDropIndicator // enables drop indicator
      />
  ...
  return (
    <View style={styles.container}>
      <Sortable.Grid
        ...
        columns={3}
        data={DATA}
        DropIndicatorComponent={DropIndicator} // custom drop indicator component
        renderItem={renderItem}
        rowGap={10}
        showDropIndicator // enables drop indicator
      />
