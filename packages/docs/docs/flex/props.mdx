...
| type                                                   | default      | required |
| ------------------------------------------------------ | ------------ | -------- |
| `'flex-start' \| 'flex-end' \| 'center' \| 'baseline'` | 'flex-start' | NO       |
...
| type            | default                | required |
| --------------- | ---------------------- | -------- |
| `Extrapolation` | `Extrapolation.EXTEND` | NO       |
...
| type                      | default                           | required |
| ------------------------- | --------------------------------- | -------- |
| `LayoutAnimation \| null` | SortableItemEntering\* / null\*\* | NO       |
...
| type                      | default                          | required |
| ------------------------- | -------------------------------- | -------- |
| `LayoutAnimation \| null` | SortableItemExiting\* / null\*\* | NO       |
...
Controls whether the zIndex of the sortable container should be raised when a drag starts. This makes the dragged item render above sibling components outside of the flex component.
...
:::info
If dragged items still appear under other components, wrap the surrounding content in a [Layer](/helper-components/layer) component.
:::
...
Increase it if items of your flex component are measured in multiple batches and you see the layout being recalculated more than once.
